defmodule InfotechCalendarWeb.UserAuthTest do
  use InfotechCalendarWeb.ConnCase

  alias Phoenix.LiveView
  alias InfotechCalendar.Accounts
  alias InfotechCalendarWeb.UserAuth
  import InfotechCalendar.AccountsFixtures
  ...
  setup %{conn: conn} do
    conn =
      ...
      |> Map.replace!(
        :secret_key_base,
        InfotechCalendarWeb.Endpoint.config(:secret_key_base)
      )
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      InfotechCalendarWeb.Endpoint.subscribe(live_socket_id)
  ...
  describe "on_mount :ensure_authenticated" do
    ...
    test "redirects to login page if there isn't a valid user_token", %{
      ...
      socket = %LiveView.Socket{
        endpoint: InfotechCalendarWeb.Endpoint,
